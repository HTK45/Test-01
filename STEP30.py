...
def Sub30(uploaded_file_01, uploaded_file_02, Time1, Var1, Var2, Var3,Thlethould_Set, Thlethould_Set2, th_add, AnalysisPeriod, Var1_Check, Var2_Check, Var3_Check, ex_Var1, ex_Var1_Check, ex_Time):
    ...
    Step41 = GRFz_n_Func(80+n,81+n); Step42 = GRFz_n_Func(82+n,83+n); Step43 = GRFz_n_Func(84+n,85+n); Step44 = GRFz_n_Func(86+n,87+n); Step45 = GRFz_n_Func(88+n,89+n);
    Step46 = GRFz_n_Func(90+n,91+n); Step47 = GRFz_n_Func(92+n,93+n); Step48 = GRFz_n_Func(94+n,95+n); Step49 = GRFz_n_Func(96+n,97+n); Step50 = GRFz_n_Func(98+n,99+n)
    Step51 = GRFz_n_Func(100+n,101+n); Step52 = GRFz_n_Func(102+n,103+n); Step53 = GRFz_n_Func(104+n,105+n); Step54 = GRFz_n_Func(106+n,107+n); Step55 = GRFz_n_Func(108+n,109+n)
    Step56 = GRFz_n_Func(110+n,111+n); Step57 = GRFz_n_Func(112+n,113+n); Step58 = GRFz_n_Func(114+n,115+n); Step59 = GRFz_n_Func(116+n,117+n); Step60 = GRFz_n_Func(118+n,119+n); Step61 = GRFz_n_Func(120+n,121+n);
    ...
    Time31 = Step31['Time']; Time32 = Step32['Time']; Time33 = Step33['Time']; Time34 = Step34['Time']; Time35 = Step35['Time']; Time36 = Step36['Time']; Time37 = Step37['Time']; Time38 = Step38['Time']; Time39 = Step39['Time']; Time40 = Step40['Time']
    Time41 = Step41['Time']; Time42 = Step42['Time']; Time43 = Step43['Time']; Time44 = Step44['Time']; Time45 = Step45['Time']; Time46 = Step46['Time']; Time47 = Step47['Time']; Time48 = Step48['Time']; Time49 = Step49['Time']; Time50 = Step50['Time']
    Time51 = Step51['Time']; Time52 = Step52['Time']; Time53 = Step53['Time']; Time54 = Step54['Time']; Time55 = Step55['Time']; Time56 = Step56['Time']; Time57 = Step57['Time']; Time58 = Step58['Time']; Time59 = Step59['Time']; Time60 = Step60['Time']; Time61 = Step61['Time']
    ...
    GRFx31 = Step31['GRFx']; GRFx32 = Step32['GRFx']; GRFx33 = Step33['GRFx']; GRFx34 = Step34['GRFx']; GRFx35 = Step35['GRFx']; GRFx36 = Step36['GRFx']; GRFx37 = Step37['GRFx']; GRFx38 = Step38['GRFx']; GRFx39 = Step39['GRFx']; GRFx40 = Step40['GRFx']
    GRFx41 = Step41['GRFx']; GRFx42 = Step42['GRFx']; GRFx43 = Step43['GRFx']; GRFx44 = Step44['GRFx']; GRFx45 = Step45['GRFx']; GRFx46 = Step46['GRFx']; GRFx47 = Step47['GRFx']; GRFx48 = Step48['GRFx']; GRFx49 = Step49['GRFx']; GRFx50 = Step50['GRFx']
    GRFx51 = Step51['GRFx']; GRFx52 = Step52['GRFx']; GRFx53 = Step53['GRFx']; GRFx54 = Step54['GRFx']; GRFx55 = Step55['GRFx']; GRFx56 = Step56['GRFx']; GRFx57 = Step57['GRFx']; GRFx58 = Step58['GRFx']; GRFx59 = Step59['GRFx']; GRFx60 = Step60['GRFx']; GRFx61 = Step31['GRFx']
    ...
    GRFy31 = Step31['GRFy']; GRFy32 = Step32['GRFy']; GRFy33 = Step33['GRFy']; GRFy34 = Step34['GRFy']; GRFy35 = Step35['GRFy']; GRFy36 = Step36['GRFy']; GRFy37 = Step37['GRFy']; GRFy38 = Step38['GRFy']; GRFy39 = Step39['GRFy']; GRFy40 = Step40['GRFy']
    GRFy41 = Step41['GRFy']; GRFy42 = Step42['GRFy']; GRFy43 = Step43['GRFy']; GRFy44 = Step44['GRFy']; GRFy45 = Step45['GRFy']; GRFy46 = Step46['GRFy']; GRFy47 = Step47['GRFy']; GRFy48 = Step48['GRFy']; GRFy49 = Step49['GRFy']; GRFy50 = Step50['GRFy']
    GRFy51 = Step51['GRFy']; GRFy52 = Step52['GRFy']; GRFy53 = Step53['GRFy']; GRFy54 = Step54['GRFy']; GRFy55 = Step55['GRFy']; GRFy56 = Step56['GRFy']; GRFy57 = Step57['GRFy']; GRFy58 = Step58['GRFy']; GRFy59 = Step59['GRFy']; GRFy60 = Step60['GRFy']; GRFy61 = Step31['GRFy']
    ...
    GRFz31 = Step31['GRFz']; GRFz32 = Step32['GRFz']; GRFz33 = Step33['GRFz']; GRFz34 = Step34['GRFz']; GRFz35 = Step35['GRFz']; GRFz36 = Step36['GRFz']; GRFz37 = Step37['GRFz']; GRFz38 = Step38['GRFz']; GRFz39 = Step39['GRFz']; GRFz40 = Step40['GRFz']
    GRFz41 = Step41['GRFz']; GRFz42 = Step42['GRFz']; GRFz43 = Step43['GRFz']; GRFz44 = Step44['GRFz']; GRFz45 = Step45['GRFz']; GRFz46 = Step46['GRFz']; GRFz47 = Step47['GRFz']; GRFz48 = Step48['GRFz']; GRFz49 = Step49['GRFz']; GRFz50 = Step50['GRFz']
    GRFz51 = Step51['GRFz']; GRFz52 = Step52['GRFz']; GRFz53 = Step53['GRFz']; GRFz54 = Step54['GRFz']; GRFz55 = Step55['GRFz']; GRFz56 = Step56['GRFz']; GRFz57 = Step57['GRFz']; GRFz58 = Step58['GRFz']; GRFz59 = Step59['GRFz']; GRFz60 = Step60['GRFz']; GRFz61 = Step31['GRFz']
    ...
    GRFx_Spline['Step21']=Spline_Func(GRFx21); GRFx_Spline['Step22']=Spline_Func(GRFx12); GRFx_Spline['Step23']=Spline_Func(GRFx23); GRFx_Spline['Step24']=Spline_Func(GRFx24); GRFx_Spline['Step25']=Spline_Func(GRFx25);
    ...
    GRFx_Spline['Step41']=Spline_Func(GRFx41); GRFx_Spline['Step42']=Spline_Func(GRFx42); GRFx_Spline['Step43']=Spline_Func(GRFx43); GRFx_Spline['Step44']=Spline_Func(GRFx44); GRFx_Spline['Step45']=Spline_Func(GRFx45);
    GRFx_Spline['Step46']=Spline_Func(GRFx46); GRFx_Spline['Step47']=Spline_Func(GRFx47); GRFx_Spline['Step48']=Spline_Func(GRFx48); GRFx_Spline['Step49']=Spline_Func(GRFx49); GRFx_Spline['Step50']=Spline_Func(GRFx50);
    GRFx_Spline['Step51']=Spline_Func(GRFx51); GRFx_Spline['Step52']=Spline_Func(GRFx52); GRFx_Spline['Step53']=Spline_Func(GRFx53); GRFx_Spline['Step54']=Spline_Func(GRFx54); GRFx_Spline['Step55']=Spline_Func(GRFx55);
    GRFx_Spline['Step56']=Spline_Func(GRFx56);  GRFx_Spline['Step57']=Spline_Func(GRFx57); GRFx_Spline['Step58']=Spline_Func(GRFx58); GRFx_Spline['Step59']=Spline_Func(GRFx59); GRFx_Spline['Step60']=Spline_Func(GRFx60);
    #GRFy
    ...
    GRFy_Spline['Step41']=Spline_Func(GRFy41); GRFy_Spline['Step42']=Spline_Func(GRFy42); GRFy_Spline['Step43']=Spline_Func(GRFy43); GRFy_Spline['Step44']=Spline_Func(GRFy44); GRFy_Spline['Step45']=Spline_Func(GRFy45);
    GRFy_Spline['Step46']=Spline_Func(GRFy46); GRFy_Spline['Step47']=Spline_Func(GRFy47); GRFy_Spline['Step48']=Spline_Func(GRFy48); GRFy_Spline['Step49']=Spline_Func(GRFy49); GRFy_Spline['Step50']=Spline_Func(GRFy50);
    GRFy_Spline['Step51']=Spline_Func(GRFy51); GRFy_Spline['Step52']=Spline_Func(GRFy52); GRFy_Spline['Step53']=Spline_Func(GRFy53); GRFy_Spline['Step54']=Spline_Func(GRFy54); GRFy_Spline['Step55']=Spline_Func(GRFy55);
    GRFy_Spline['Step56']=Spline_Func(GRFy56);  GRFy_Spline['Step57']=Spline_Func(GRFy57); GRFy_Spline['Step58']=Spline_Func(GRFy58); GRFy_Spline['Step59']=Spline_Func(GRFy59); GRFy_Spline['Step60']=Spline_Func(GRFy60);
    #GRFz
    ...
    GRFz_Spline['Step41']=Spline_Func(GRFz41); GRFz_Spline['Step42']=Spline_Func(GRFz42); GRFz_Spline['Step43']=Spline_Func(GRFz43); GRFz_Spline['Step44']=Spline_Func(GRFz44); GRFz_Spline['Step45']=Spline_Func(GRFz45);
    GRFz_Spline['Step46']=Spline_Func(GRFz46); GRFz_Spline['Step47']=Spline_Func(GRFz47); GRFz_Spline['Step48']=Spline_Func(GRFz48); GRFz_Spline['Step49']=Spline_Func(GRFz49); GRFz_Spline['Step50']=Spline_Func(GRFz50);
    GRFz_Spline['Step51']=Spline_Func(GRFz51); GRFz_Spline['Step52']=Spline_Func(GRFz52); GRFz_Spline['Step53']=Spline_Func(GRFz53); GRFz_Spline['Step54']=Spline_Func(GRFz54); GRFz_Spline['Step55']=Spline_Func(GRFz55);
    GRFz_Spline['Step56']=Spline_Func(GRFz56);  GRFz_Spline['Step57']=Spline_Func(GRFz57); GRFz_Spline['Step58']=Spline_Func(GRFz58); GRFz_Spline['Step59']=Spline_Func(GRFz59); GRFz_Spline['Step60']=Spline_Func(GRFz60);
    ...
    GRFz_fig.line(Time41, GRFz41,line_color=LC_th, line_width = LW); GRFz_fig.line(Time42, GRFz42,line_color=LC_th, line_width = LW); GRFz_fig.line(Time43, GRFz43,line_color=LC_th, line_width = LW); GRFz_fig.line(Time44, GRFz44,line_color=LC_th, line_width = LW); GRFz_fig.line(Time45, GRFz45,line_color=LC_th, line_width = LW)
    GRFz_fig.line(Time46, GRFz46,line_color=LC_th, line_width = LW); GRFz_fig.line(Time47, GRFz47,line_color=LC_th, line_width = LW); GRFz_fig.line(Time48, GRFz48,line_color=LC_th, line_width = LW); GRFz_fig.line(Time49, GRFz49,line_color=LC_th, line_width = LW); GRFz_fig.line(Time50, GRFz50,line_color=LC_th, line_width = LW)
    GRFz_fig.line(Time51, GRFz51,line_color=LC_th, line_width = LW); GRFz_fig.line(Time52, GRFz52,line_color=LC_th, line_width = LW); GRFz_fig.line(Time53, GRFz53,line_color=LC_th, line_width = LW); GRFz_fig.line(Time54, GRFz54,line_color=LC_th, line_width = LW); GRFz_fig.line(Time55, GRFz55,line_color=LC_th, line_width = LW)
    GRFz_fig.line(Time56, GRFz56,line_color=LC_th, line_width = LW); GRFz_fig.line(Time57, GRFz57,line_color=LC_th, line_width = LW); GRFz_fig.line(Time58, GRFz58,line_color=LC_th, line_width = LW); GRFz_fig.line(Time59, GRFz59,line_color=LC_th, line_width = LW); GRFz_fig.line(Time60, GRFz60,line_color=LC_th, line_width = LW)
    ...
    if SideButton2:
        ...
        df1['Time41']=Time41; df1['Time42']=Time42; df1['Time43']=Time43; df1['Time44']=Time44; df1['Time45']=Time45; df1['Time46']=Time46; df1['Time47']=Time47; df1['Time48']=Time48; df1['Time49']=Time49; df1['Time50']=Time50
        df1['Time51']=Time51; df1['Time52']=Time52; df1['Time53']=Time53; df1['Time54']=Time54; df1['Time55']=Time55; df1['Time56']=Time56; df1['Time57']=Time57; df1['Time58']=Time58; df1['Time59']=Time59; df1['Time60']=Time60
        ...
        df1['GRFz41']=GRFz41; df1['GRFz42']=GRFz42; df1['GRFz43']=GRFz43; df1['GRFz44']=GRFz44; df1['GRFz45']=GRFz45; df1['GRFz46']=GRFz46; df1['GRFz47']=GRFz47; df1['GRFz48']=GRFz48; df1['GRFz49']=GRFz49; df1['GRFz50']=GRFz50
        df1['GRFz51']=GRFz51; df1['GRFz52']=GRFz52; df1['GRFz53']=GRFz53; df1['GRFz54']=GRFz54; df1['GRFz55']=GRFz55; df1['GRFz56']=GRFz56; df1['GRFz57']=GRFz57; df1['GRFz58']=GRFz58; df1['GRFz59']=GRFz59; df1['GRFz60']=GRFz60
        ...
        df1['GRFy41']=GRFy41; df1['GRFy42']=GRFy42; df1['GRFy43']=GRFy43; df1['GRFy44']=GRFy44; df1['GRFy45']=GRFy45; df1['GRFy46']=GRFy46; df1['GRFy47']=GRFy47; df1['GRFy48']=GRFy48; df1['GRFy49']=GRFy49; df1['GRFy50']=GRFy50
        df1['GRFy51']=GRFy51; df1['GRFy52']=GRFy52; df1['GRFy53']=GRFy53; df1['GRFy54']=GRFy54; df1['GRFy55']=GRFy55; df1['GRFy56']=GRFy56; df1['GRFy57']=GRFy57; df1['GRFy58']=GRFy58; df1['GRFy59']=GRFy59; df1['GRFy60']=GRFy60
        ...
        GRF_fig.line(Time41, GRFz41,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time42, GRFz42,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time43, GRFz43,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time44, GRFz44,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time45, GRFz45,line_color=LC_GRFz, line_width = LW)
        GRF_fig.line(Time46, GRFz46,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time47, GRFz47,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time48, GRFz48,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time49, GRFz49,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time50, GRFz50,line_color=LC_GRFz, line_width = LW)
        GRF_fig.line(Time51, GRFz51,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time52, GRFz52,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time53, GRFz53,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time54, GRFz54,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time55, GRFz55,line_color=LC_GRFz, line_width = LW)
        GRF_fig.line(Time56, GRFz56,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time57, GRFz57,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time58, GRFz58,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time59, GRFz59,line_color=LC_GRFz, line_width = LW); GRF_fig.line(Time60, GRFz60,line_color=LC_GRFz, line_width = LW)
        ...
        GRF_fig.line(Time41, GRFy41,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time42, GRFy42,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time43, GRFy43,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time44, GRFy44,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time45, GRFy45,line_color=LC_GRFy, line_width = LW)
        GRF_fig.line(Time46, GRFy46,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time47, GRFy47,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time48, GRFy48,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time49, GRFy49,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time50, GRFy50,line_color=LC_GRFy, line_width = LW)
        GRF_fig.line(Time51, GRFy51,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time52, GRFy52,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time53, GRFy53,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time54, GRFy54,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time55, GRFy55,line_color=LC_GRFy, line_width = LW)
        GRF_fig.line(Time56, GRFy56,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time57, GRFy57,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time58, GRFy58,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time59, GRFy59,line_color=LC_GRFy, line_width = LW); GRF_fig.line(Time60, GRFy60,line_color=LC_GRFy, line_width = LW)
    ...
    if Var1_Check:  #GRFx
        ...
        if SideButton_Fx_R:
            ...
            GRFx_Spline['Step41']=Spline_Func(GRFx41);  GRFx_Spline['Step43']=Spline_Func(GRFx43);  GRFx_Spline['Step45']=Spline_Func(GRFx45);  GRFx_Spline['Step47']=Spline_Func(GRFx47);  GRFx_Spline['Step49']=Spline_Func(GRFx49);
            GRFx_Spline['Step51']=Spline_Func(GRFx51);  GRFx_Spline['Step53']=Spline_Func(GRFx53);  GRFx_Spline['Step55']=Spline_Func(GRFx55);  GRFx_Spline['Step57']=Spline_Func(GRFx57);  GRFx_Spline['Step59']=Spline_Func(GRFx59);
            # データフレーム
        ...
        if SideButton_Fx_L:
            ...
            GRFx_Spline['Step42']=Spline_Func(GRFx42);  GRFx_Spline['Step44']=Spline_Func(GRFx44);  GRFx_Spline['Step46']=Spline_Func(GRFx46);   GRFx_Spline['Step48']=Spline_Func(GRFx48); GRFx_Spline['Step50']=Spline_Func(GRFx50);
            GRFx_Spline['Step52']=Spline_Func(GRFx52);  GRFx_Spline['Step54']=Spline_Func(GRFx54);  GRFx_Spline['Step58']=Spline_Func(GRFx56);   GRFx_Spline['Step58']=Spline_Func(GRFx58); GRFx_Spline['Step60']=Spline_Func(GRFx60);
            # データフレーム
            st.dataframe(GRFx_Spline, width=1000, height=150)
            # Copy?
    ...
    if Var2_Check:  #GRFy
        ...
        if SideButton_Fy_R:
            ...
            GRFy_Spline['Step41']=Spline_Func(GRFy41);  GRFy_Spline['Step43']=Spline_Func(GRFy43);  GRFy_Spline['Step45']=Spline_Func(GRFy45);  GRFy_Spline['Step47']=Spline_Func(GRFy47);  GRFy_Spline['Step49']=Spline_Func(GRFy49);
            GRFy_Spline['Step51']=Spline_Func(GRFy51);  GRFy_Spline['Step53']=Spline_Func(GRFy53);  GRFy_Spline['Step55']=Spline_Func(GRFy55);  GRFy_Spline['Step57']=Spline_Func(GRFy57);  GRFy_Spline['Step59']=Spline_Func(GRFy59);
            # データフレーム
        ...
        if SideButton_Fy_L:
            ...
            GRFy_Spline['Step42']=Spline_Func(GRFy42);  GRFy_Spline['Step44']=Spline_Func(GRFy44);  GRFy_Spline['Step46']=Spline_Func(GRFy46);   GRFy_Spline['Step48']=Spline_Func(GRFy48); GRFy_Spline['Step50']=Spline_Func(GRFy50);
            GRFy_Spline['Step52']=Spline_Func(GRFy52);  GRFy_Spline['Step54']=Spline_Func(GRFy54);  GRFy_Spline['Step58']=Spline_Func(GRFy56);   GRFy_Spline['Step58']=Spline_Func(GRFy58); GRFy_Spline['Step60']=Spline_Func(GRFy60);
            # データフレーム
            st.dataframe(GRFy_Spline, width=1000, height=150)
            # Copy?
            copy_button1_1 = Button(label="Copy: GRFy")
    ...
    if Var3_Check:  #GRFz
        ...
        if SideButton_Fz_R:
            ...
            GRFz_Spline['Step41']=Spline_Func(GRFz41);  GRFz_Spline['Step43']=Spline_Func(GRFz43);  GRFz_Spline['Step45']=Spline_Func(GRFz45);  GRFz_Spline['Step47']=Spline_Func(GRFz47);  GRFz_Spline['Step49']=Spline_Func(GRFz49);
            GRFz_Spline['Step51']=Spline_Func(GRFz51);  GRFz_Spline['Step53']=Spline_Func(GRFz53);  GRFz_Spline['Step55']=Spline_Func(GRFz55);  GRFz_Spline['Step57']=Spline_Func(GRFz57);  GRFz_Spline['Step59']=Spline_Func(GRFz59);
            # データフレーム
        ...
        if SideButton_Fz_L:
            ...
            GRFz_Spline['Step42']=Spline_Func(GRFz42);  GRFz_Spline['Step44']=Spline_Func(GRFz44);  GRFz_Spline['Step46']=Spline_Func(GRFz46);   GRFz_Spline['Step48']=Spline_Func(GRFz48); GRFz_Spline['Step50']=Spline_Func(GRFz50);
            GRFz_Spline['Step52']=Spline_Func(GRFz52);  GRFz_Spline['Step54']=Spline_Func(GRFz54);  GRFz_Spline['Step58']=Spline_Func(GRFz56);   GRFz_Spline['Step58']=Spline_Func(GRFz58); GRFz_Spline['Step60']=Spline_Func(GRFz60);
            # データフレーム
            st.dataframe(GRFz_Spline, width=1000, height=150)
            # Copy?
...
#_____________________________________________________________________________________________________________________________________________________________________________________________
    ...
    if SideButton_PhaseTime_R:
        ...
        PhaseTime['Step41']=PhaseTime_Func(Time41, Time42);
        PhaseTime['Step43']=PhaseTime_Func(Time43, Time44);
        PhaseTime['Step45']=PhaseTime_Func(Time45, Time46);
        PhaseTime['Step47']=PhaseTime_Func(Time47, Time48);
        PhaseTime['Step49']=PhaseTime_Func(Time49, Time50);
        PhaseTime['Step51']=PhaseTime_Func(Time51, Time52);
        PhaseTime['Step53']=PhaseTime_Func(Time53, Time54);
        PhaseTime['Step55']=PhaseTime_Func(Time55, Time56);
        PhaseTime['Step57']=PhaseTime_Func(Time57, Time58);
        PhaseTime['Step59']=PhaseTime_Func(Time59, Time60);
    ...
    if SideButton_PhaseTime_L:
        ...
        PhaseTime['Step42']=PhaseTime_Func(Time42, Time43);
        PhaseTime['Step44']=PhaseTime_Func(Time44, Time45);
        PhaseTime['Step46']=PhaseTime_Func(Time46, Time47);
        PhaseTime['Step48']=PhaseTime_Func(Time48, Time49);
        PhaseTime['Step50']=PhaseTime_Func(Time50, Time51);
        PhaseTime['Step52']=PhaseTime_Func(Time52, Time53);
        PhaseTime['Step54']=PhaseTime_Func(Time54, Time55);
        PhaseTime['Step56']=PhaseTime_Func(Time56, Time57);
        PhaseTime['Step58']=PhaseTime_Func(Time58, Time59);
        PhaseTime['Step60']=PhaseTime_Func(Time60, Time61);
...
#________________________________________________________________________________________________________________________
    ...
    def ExtDataAnalysis_df_Func(exDATA):
        ...
        ex_df42 = ExtDataAnalysis_Func(Time42, exDATA, 'Time42', 'DATA42'); ex_df42.reset_index(inplace=True, drop=True)
        ex_df43 = ExtDataAnalysis_Func(Time43, exDATA, 'Time43', 'DATA43'); ex_df43.reset_index(inplace=True, drop=True)
        ex_df44 = ExtDataAnalysis_Func(Time44, exDATA, 'Time44', 'DATA44'); ex_df44.reset_index(inplace=True, drop=True)
        ex_df45 = ExtDataAnalysis_Func(Time45, exDATA, 'Time45', 'DATA45'); ex_df45.reset_index(inplace=True, drop=True)
        ex_df46 = ExtDataAnalysis_Func(Time46, exDATA, 'Time46', 'DATA46'); ex_df46.reset_index(inplace=True, drop=True)
        ex_df47 = ExtDataAnalysis_Func(Time47, exDATA, 'Time47', 'DATA47'); ex_df47.reset_index(inplace=True, drop=True)
        ex_df48 = ExtDataAnalysis_Func(Time48, exDATA, 'Time48', 'DATA48'); ex_df48.reset_index(inplace=True, drop=True)
        ex_df49 = ExtDataAnalysis_Func(Time49, exDATA, 'Time49', 'DATA49'); ex_df49.reset_index(inplace=True, drop=True)
        ex_df50 = ExtDataAnalysis_Func(Time50, exDATA, 'Time50', 'DATA50'); ex_df50.reset_index(inplace=True, drop=True)
        ex_df51 = ExtDataAnalysis_Func(Time51, exDATA, 'Time51', 'DATA51'); ex_df51.reset_index(inplace=True, drop=True)
        ex_df52 = ExtDataAnalysis_Func(Time52, exDATA, 'Time52', 'DATA52'); ex_df52.reset_index(inplace=True, drop=True)
        ex_df53 = ExtDataAnalysis_Func(Time53, exDATA, 'Time53', 'DATA53'); ex_df53.reset_index(inplace=True, drop=True)
        ex_df54 = ExtDataAnalysis_Func(Time54, exDATA, 'Time54', 'DATA54'); ex_df54.reset_index(inplace=True, drop=True)
        ex_df55 = ExtDataAnalysis_Func(Time55, exDATA, 'Time55', 'DATA55'); ex_df55.reset_index(inplace=True, drop=True)
        ex_df56 = ExtDataAnalysis_Func(Time56, exDATA, 'Time56', 'DATA56'); ex_df56.reset_index(inplace=True, drop=True)
        ex_df57 = ExtDataAnalysis_Func(Time57, exDATA, 'Time57', 'DATA57'); ex_df57.reset_index(inplace=True, drop=True)
        ex_df58 = ExtDataAnalysis_Func(Time58, exDATA, 'Time58', 'DATA58'); ex_df58.reset_index(inplace=True, drop=True)
        ex_df59 = ExtDataAnalysis_Func(Time59, exDATA, 'Time59', 'DATA59'); ex_df59.reset_index(inplace=True, drop=True)
        ex_df60 = ExtDataAnalysis_Func(Time60, exDATA, 'Time60', 'DATA60'); ex_df60.reset_index(inplace=True, drop=True)
        ...
        Extra_df = pd.concat([ex_df1,ex_df2,ex_df3,ex_df4,ex_df5,ex_df6,ex_df7,ex_df8,ex_df9,ex_df10,
                              ...
                              ex_df31,ex_df32,ex_df33,ex_df34,ex_df35,ex_df36,ex_df37,ex_df38,ex_df39,ex_df40,
                              ex_df41,ex_df42,ex_df43,ex_df44,ex_df45,ex_df46,ex_df47,ex_df48,ex_df49,ex_df50,
                              ex_df51,ex_df52,ex_df53,ex_df54,ex_df55,ex_df56,ex_df57,ex_df58,ex_df59,ex_df60],axis=1)
        return Extra_df
    ...
    ex_fig.line(ex_Table['Time41'], ex_Table['DATA41'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time42'], ex_Table['DATA42'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time43'], ex_Table['DATA43'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time44'], ex_Table['DATA44'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time45'], ex_Table['DATA45'],line_color=LC_DATA, line_width = LW);
    ex_fig.line(ex_Table['Time46'], ex_Table['DATA46'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time47'], ex_Table['DATA47'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time48'], ex_Table['DATA48'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time49'], ex_Table['DATA49'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time50'], ex_Table['DATA50'],line_color=LC_DATA, line_width = LW);
    ex_fig.line(ex_Table['Time51'], ex_Table['DATA51'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time52'], ex_Table['DATA52'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time53'], ex_Table['DATA53'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time54'], ex_Table['DATA54'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time55'], ex_Table['DATA55'],line_color=LC_DATA, line_width = LW);
    ex_fig.line(ex_Table['Time56'], ex_Table['DATA56'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time57'], ex_Table['DATA57'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time58'], ex_Table['DATA58'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time59'], ex_Table['DATA59'],line_color=LC_DATA, line_width = LW);    ex_fig.line(ex_Table['Time60'], ex_Table['DATA60'],line_color=LC_DATA, line_width = LW)
    ...
    if SideButton_Ex_Spline_R:
        ...
        ex_Table_Spline['Step41']=Spline_Func(ex_Table['DATA41']);  ex_Table_Spline['Step43']=Spline_Func(ex_Table['DATA43']);  ex_Table_Spline['Step45']=Spline_Func(ex_Table['DATA45']);  ex_Table_Spline['Step47']=Spline_Func(ex_Table['DATA47']);  ex_Table_Spline['Step49']=Spline_Func(ex_Table['DATA49']);
        ex_Table_Spline['Step51']=Spline_Func(ex_Table['DATA51']);  ex_Table_Spline['Step53']=Spline_Func(ex_Table['DATA53']);  ex_Table_Spline['Step55']=Spline_Func(ex_Table['DATA55']);  ex_Table_Spline['Step57']=Spline_Func(ex_Table['DATA57']);  ex_Table_Spline['Step59']=Spline_Func(ex_Table['DATA59']);
    ...
    if SideButton_Ex_Spline_L:
        ...
        ex_Table_Spline['Step22']=Spline_Func(ex_Table['DATA22']);  ex_Table_Spline['Step24']=Spline_Func(ex_Table['DATA24']);  ex_Table_Spline['Step26']=Spline_Func(ex_Table['DATA26']);  ex_Table_Spline['Step28']=Spline_Func(ex_Table['DATA28']);  ex_Table_Spline['Step30']=Spline_Func(ex_Table['DATA30']);
        ex_Table_Spline['Step32']=Spline_Func(ex_Table['DATA32']);  ex_Table_Spline['Step34']=Spline_Func(ex_Table['DATA34']);  ex_Table_Spline['Step36']=Spline_Func(ex_Table['DATA36']);  ex_Table_Spline['Step38']=Spline_Func(ex_Table['DATA38']);  ex_Table_Spline['Step40']=Spline_Func(ex_Table['DATA40']);
        ex_Table_Spline['Step42']=Spline_Func(ex_Table['DATA42']);  ex_Table_Spline['Step44']=Spline_Func(ex_Table['DATA44']);  ex_Table_Spline['Step46']=Spline_Func(ex_Table['DATA46']);  ex_Table_Spline['Step48']=Spline_Func(ex_Table['DATA48']);  ex_Table_Spline['Step50']=Spline_Func(ex_Table['DATA50']);
        ex_Table_Spline['Step52']=Spline_Func(ex_Table['DATA52']);  ex_Table_Spline['Step54']=Spline_Func(ex_Table['DATA54']);  ex_Table_Spline['Step56']=Spline_Func(ex_Table['DATA56']);  ex_Table_Spline['Step58']=Spline_Func(ex_Table['DATA58']);  ex_Table_Spline['Step60']=Spline_Func(ex_Table['DATA60']);
